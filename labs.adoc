...
spring.ai.vectorstore.neo4j.index-name=news_openai_small
...
http ":8080/manualGraphRAG?question=What types of organizations are dealing with major investments recently?"
```
